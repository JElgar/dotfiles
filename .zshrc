...
alias p="python ~/Documents/Development/LaptopProjects/AutoRemoteScript/AutoRemotePhoneScript.py"
...
function touch_open { touch "$@"; open "$@"; }
export PATH=$PATH:/home/james/Android/Sdk/platform-tools
